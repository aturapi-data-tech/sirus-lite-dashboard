...
export default function Authenticated({ user, header, children }) {
    ...
    const [showingNavigationSideBar, setShowingNavigationSideBar] = useState(false);


    return (
        <div className="min-h-screen bg-gray-100">
            <nav className="bg-white border-b border-gray-100">
                <div className="px-4 mx-auto sm:px-2 lg:px-4">
                    <div className="flex justify-between h-16">
                        <div className="flex">

                            <div className="flex items-center mr-2 ">
                                <button
                                    onClick={() => setShowingNavigationSideBar((previousState) => !previousState)}

                                    className="inline-flex items-center justify-center p-2 text-gray-400 transition duration-150 ease-in-out rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500"
                                >
                                    <svg className="w-6 h-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                                        <path
                                            className={!showingNavigationSideBar ? 'inline-flex' : 'hidden'}
                                            strokeLinecap="round"
                            ...
                            <div className="flex items-center shrink-0">
                                ...
                                <Link href="/">
                                    ...
                                    <img src="/favicon.svg" className="mr-3 h-14 sm:h-14" alt="siRUS Logo" />
