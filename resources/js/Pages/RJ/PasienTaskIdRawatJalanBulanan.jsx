        ...
        <PageLayout user={auth.user}>
            ...
            <div className='h-[calc(100vh-100px)]  p-4 bg-white border border-gray-200 rounded-lg shadow-sm '>
                ...
                <div className='flex justify-between'>
                    <div>
                        Jumlah Antrian : <span className='font-bold'>{queryPasienEMRRJBulanan.total}</span>
                    </div>
                    <div>
                        Jumlah Antrian Lengkap :<span className='font-bold'>{getlistTaskIdAntrianLengkapBulanan}</span>
                    </div>
                    <div>
                        Jumlah Antrian Tidak Lengkap : <span className='font-bold'>{queryPasienEMRRJBulanan.total - getlistTaskIdAntrianLengkapBulanan}</span>

                    </div>
                </div>
                <div className='flex justify-between'>
                    <div>
                        Rata Waktu Pelayanan Poli : <span className='font-bold'>{convertRataWaktuLayanan(getRataWaktuLayananPoliBulanan)}</span>
                    </div>

                    <div>
                        Rata Waktu Pelayanan Apotek : <span className='font-bold'>{convertRataWaktuLayanan(getRataWaktuLayananApotekBulanan)}</span>
                    </div>
                ...
                <div className='h-[calc(100vh-180px)] overflow-auto'>
                    <Table hoverable>
                        ...
                        <Table.Body className="divide-y">
                            {queryPasienEMRRJBulanan.data.map((item, index) => (
                    ...
                    <div className='sticky bottom-0 flex justify-end rounded-b-lg bg-gray-50'>
                        <PaginationData className="mt-6" links={queryPasienEMRRJBulanan.links} total={queryPasienEMRRJBulanan.total} from={queryPasienEMRRJBulanan.from} to={queryPasienEMRRJBulanan.to} current_page={queryPasienEMRRJBulanan.current_page} last_page={queryPasienEMRRJBulanan.last_page} />
                    </div>
                </div>
